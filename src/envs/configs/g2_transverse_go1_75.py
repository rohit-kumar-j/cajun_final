...
def get_config():
    ...
    robot_config.urdf_path = "data/go1/urdf/go1_u75.urdf"  # switched to Go1 to match baseline
    ...
    raibert_config.desired_base_height    = 0.235    # matches original RaibertSwingLegController default
    ...
    qp_config.body_mass    = 9.5888   # Go1 mass (matches go1.urdf; was 15.018 for Go2)
    ...
    env_config.terminate_on_height         = 0.05
