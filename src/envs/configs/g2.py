...
def get_config():
  ...
  gait_config.stepping_frequency = 2  #TODO: 2.5
  ...
  config.goal_ub = torch.tensor([3.0, 0.], dtype=torch.float)
  ...
  config.mirror_foot_action = False
  ...
  config.base_orientation_kp = np.array([50., 50., 50.])
